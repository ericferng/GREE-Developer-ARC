 ...
 * currently this class uses snsapi

 * getWithParameters:block:
 ** parameters:
 *** GreeAPIParameterKeyStartIndex
 *** GreeAPIParameterKeyPageSize
 *** GreeExternalSocialGraphParameterKeyServiceType: GreeExternalSocialGraphParameterServiceType***
 ** object in block parameter:
 *** success: GreeExternalSocialGraph instance
 *** failure: nil

 * postWithParameters:block:
 ** parameters:
 *** token: the access token string
 *** type: GreeExternalSocialGraphTokenTypeFacebook
 ** object in block parameter:
 *** success: nil
 *** failure: nil
 */
