...
#import "GreeJSReloadUniversalMenuCommand.h"
#import "GreeUniversalMenuViewController.h"
#import "GreeMenuNavController.h"
#import "UIViewController+GreeAdditions.h"

@implementation GreeJSReloadUniversalMenuCommand

#pragma mark - GreeJSCommand Overrides

+(NSString*)name
{
  return @"reload_universal_menu";
}

-(void)execute:(NSDictionary*)params
{
  GreeMenuNavController* menuNavController = (GreeMenuNavController*)[UIViewController greeLastPresentedViewController];
  GreeUniversalMenuViewController* universalMenu
    = (GreeUniversalMenuViewController*)[(UINavigationController*)menuNavController.menuViewController topViewController];
  [universalMenu reload];
}
