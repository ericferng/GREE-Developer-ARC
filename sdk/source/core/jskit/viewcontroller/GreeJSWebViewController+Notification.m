...
@implementation GreeJSWebViewController (Notification)
               ...
               controller:(GreeNotificationNavigationController*)controller
{
  ...
  [nextViewController.navigationItem setHidesBackButton:YES];
  nextViewController.beforeWebViewController = self;

  [nextViewController.webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:url]]];
