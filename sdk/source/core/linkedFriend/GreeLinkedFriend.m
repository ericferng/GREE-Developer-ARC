...
@implementation GreeLinkedFriend

+(void)linkFriendWithKey:(NSString*)key
            successBlock:(void (^)(void))successBlock
            failureBlock:(void (^)(NSError* error))failureBlock
{
  NSString* endpoint = @"api/rest/linkedfriend";
  NSDictionary* params = [NSDictionary dictionaryWithObject:key forKey:@"key"];
  [[GreePlatform sharedInstance].httpClient postPath:endpoint
                                          parameters:params
