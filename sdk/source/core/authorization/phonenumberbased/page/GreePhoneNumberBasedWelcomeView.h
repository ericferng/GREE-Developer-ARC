...
@interface GreePhoneNumberBasedWelcomeView : GreePhoneNumberBasedPage
...
@interface GreePhoneNumberBasedWelcomeNavigationController : GreePhoneNumberBasedNavigationController
@end
